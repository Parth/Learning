...
void Java_paulscode_android_mupen64plus_SDLActivity_pauseEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_PAUSE, 0, NULL );
}

void Java_paulscode_android_mupen64plus_SDLActivity_resumeEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_RESUME, 0, NULL );
}

void Java_paulscode_android_mupen64plus_SDLActivity_stopEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_STOP, 0, NULL );
}

void Java_paulscode_android_mupen64plus_SDLActivity_stateSetSlotEmulator(
                                    JNIEnv* env, jclass cls, jint slotID )
{
    (*CoreDoCommand) ( M64CMD_STATE_SET_SLOT, (int) slotID, NULL );
}
void Java_paulscode_android_mupen64plus_SDLActivity_stateSaveEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_STATE_SAVE, 1, NULL );
}
void Java_paulscode_android_mupen64plus_SDLActivity_stateLoadEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_STATE_LOAD, 0, NULL );
}

void Java_paulscode_android_mupen64plus_SDLActivity_fileSaveEmulator(
...
void Java_paulscode_android_mupen64plus_SDLActivity_fileLoadEmulator(
                                    JNIEnv* env, jclass cls, jstring filename )
{
    const char *nativeString = (*env)->GetStringUTFChars( env, filename, 0 );
...
jint Java_paulscode_android_mupen64plus_SDLActivity_stateEmulator(
                                    JNIEnv* env, jclass cls)
{
    int state = 0;
...
jstring Java_paulscode_android_mupen64plus_SDLActivity_nativeGetHeaderName(

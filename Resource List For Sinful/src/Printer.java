...
public class Printer {
	...
	static String[] NAMES = new String[180];
	static int[][] COLORS = new int[180][3];
	
//	String[] _blobs = "24-7 Fig Pistache AllAboutYou Fiji Poudre Amethyst FlirtingNails PullOver Aubergine FlyAway PurpleDiamond Aubergine Folly PurRouge BaliMist ForgetNow QueenOfBeauty BeauBrique Frenzy RichInHeart BeauKhaki FusionNeon RiseAndShine BeHappy Genteel RoseEciat BeverlyHills Georgio RoseEciat BigDaddy GlassPink RougeCerisa Bikini Goergeous RougeIrise BlackOnBlack GoGoGirl RubyRuby BleuDuNuage GraineDePoivre SanFrancisco BleuElectrique GrisNacre Savage BlueByYou HappyEnding SecretAdmirer BlueDePluie Hazard SharonsHeart BoogieNights HDNails ShiningHeart BoomBoom Hottie Slate Bordeau IMissYou SnowMeWhite CallYouLater Innocent SocialLadder Carmel IrishGreen SoulMate CasaBlanca IslandCoral Starfish CiaoBella! Kissy StaringAtStars Ciel LastChance SugarSugar Cinderella Lavande SummerPeach Citrine LetMeGo Sunburnt Clementine Let'sMeet Tambleberry Cloud9 LetsTalk ThisIsIt Coffee LoveNails TokyoPearl CoolGrey Mauve Twilight CourtneyOrange MidnightBlue Under18 CreamPink MintApple Unicorn CrossMyHeart NailJunkie UpForAnything Daddy'sGirl Nirvana VacationTime DancingNails NudeDuSoir Verbena Daredevil Oasis VioletteD'Afrique DarkBronze OpalGlitter ViralOrange DreamOn OpeanSeas WhatsYourName DressedToKill OutOfThisWorld WhyNot EasyGoing Outrages Winterberry Envy Pink YouJustWait ExoticGreen PinkForever FeelingGreat PinkyGlitter".split(" ");
